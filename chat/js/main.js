...
var __VERSION_CHAT = '1.0.2506181734';
    ...
    */
    ...
    init() {
    $('#vc-model').addClass(`show-${this.position}`);
    $('#vc-head').attr('src', this.picture);
    ...
    $('.chat-product-main > .chat-product-head').css({
    backgroundColor: this.titleBackground
    });
    $('.chat-content .btns .btn1').css({
    backgroundColor: this.buttonBackground
    });
    $('.chat-content .form-chat .submit').css({
    backgroundColor: this.buttonBackground
    });
    ...
    // 弹窗
    $("#vc-model > .vc-content-main").addClass('vc-model-dialog-content-main');
    $("#vc-model > .vc-content-main").fadeTo(0.1, 0.1);
    $("#vc-model > .vc-content-main").fadeTo(0.3, 0.3);
    $("#vc-model > .vc-content-main").fadeTo(0.5, 0.5);
    $("#vc-model > .vc-content-main").fadeTo(0.7, 0.7);
    $("#vc-model > .vc-content-main").fadeTo(0.9, 0.9);
    $("#vc-model > .vc-content-main").fadeTo(1, 1);

    if (!isMobile) {
    // 增加左边的宽度
    $("#vc-model > .vc-content-main > .vc-content .chat-box").addClass('vc-model-dialog-chat-box-width');
    // 隐藏左边的关闭图标
    $("#vc-model > .vc-content-main > .vc-content > .chat-box > .chat-title > .close").addClass('vc-model-dialog-close');
    // 聊天与产品之间的竖线
    $("#vc-model > .vc-content-main > .vc-content .chat-content2").addClass('vc-model-dialog-border');
    // 右侧产品
    $("#vc-model > .vc-content-main > .vc-content > .chat-product-main").css({display: 'block'});
    }
